...
This is a newgps.navi.cc API resource built with [nanoc][nanoc].

All submissions are welcome. To submit a change, fork this repo, commit your changes, and send us a [pull request](https://github.com/baden/api.navi.cc/pulls).
