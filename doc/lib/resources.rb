...
module GitHub
  module Resources
    ...
    SYSTEM_STATUS_1   ={
        "last_position" => [],
        "main_power"    => 12.2222,
        "battary_power" => 4.2222,
        "gps_quality"   => 3,
        "gsm_quality"   => 2

    }
    SYSTEM_STATUS_2   =SYSTEM_STATUS_1.merge({
                                                 "last_position" => [
                                                     {"lat" => 123.222,
                                                      "lon" => 333.3,
                                                      "..." => "..."},
    ...
    ALL_USER_SYSTEMS  =[
        USER_SYSTEM.merge(SYSTEM_STATUS_2).merge({
                                                     "imei"     => "IMEI1",
                                                     "car_info" => NIL

                                                 }),
        USER_SYSTEM.merge(SYSTEM_STATUS_1).merge({
                                                     "imei"     => "IMEI2",
                                                     "car_info" => NIL
                                                 }),
        USER_SYSTEM.merge(SYSTEM_STATUS_1).merge({
    ...
    LOGIN = ACCOUNT.merge({
                              "token" => "6d314719-3c6a-4a02-a537-5c6c39717a0e",
    ...
    SIMPLE_SYSTEM1 = SIMPLE_SYSTEM.merge({
                                             "skey" => "SKEY1",
                                             "imei" => "IMEI1"
                                         })

    SIMPLE_SYSTEM2 = SIMPLE_SYSTEM.merge({
                                             "skey" => "SKEY2",
                                             "imei" => "IMEI2"
                                         })
    ...
    SYSTEMS = [
        {
            "result" => "added",
            "system" => SIMPLE_SYSTEM1
        },
        {
            "result" => "added",
            "system" => SIMPLE_SYSTEM2
        },
        {
            "result" => "notfound",
            "system" => nil
